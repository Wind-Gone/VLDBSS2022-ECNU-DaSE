...
from representation_model import Representation
...
def train_and_test(ctx: EncodeContext, train_start, train_end, validate_start, validate_end, num_epochs,
                   data_dir=path.join('data', 'job')):
